                    ...
                    Row(children: [
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Expanded(child: Container( width: MediaQuery.of(context).size.width/2.52, height: 40,child: MyText(text: ''),)),
                                    ],
                                  ),
                                  Row(
                                    mainAxisAlignment: MainAxisAlignment.spaceAround,
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      // const SizedBox(width: 0.7,),
                                      Expanded(child: Container( width: MediaQuery.of(context).size.width/6, height: 40,child: MyText(text: ' نوع خيط الجيب : ${cubit.quantumCapacityMedium.text}'),)),
                                      Expanded(child: Container( width: MediaQuery.of(context).size.width/6, height: 40,child: MyText(text: ' نوع الحشوة : ${cubit.Takhalis.text}'),)),
                                      Expanded(child: Container( width: MediaQuery.of(context).size.width/6, height: 40,child: MyText(text: 'نوع الجبذور : ${cubit.expectedFabricInMeter.text}'),)),
                                      Expanded(child: Container( width: MediaQuery.of(context).size.width/6, height: 40,child: MyText(text: ' '),)),
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          child: Column(
                                            ...
                                            crossAxisAlignment: CrossAxisAlignment.start,
                                            children: [
                                              Text('الكمية :${cubit.quantities.text}',style: GoogleFonts.notoKufiArabic(
                                                  color: MyConstant().purpleColor,
                                                  fontWeight: FontWeight.bold,
                                                  fontSize: 12
                                              )),
                                        ...
                                        Container(
                                          ...
                                          child: Column(
                                            ...
                                            crossAxisAlignment: CrossAxisAlignment.start,
                                            children: [
                                              Text('سعر الوحدة :${cubit.itemPrice.text}',style: GoogleFonts.notoKufiArabic(
                                                  color: MyConstant().purpleColor,
                                                  fontWeight: FontWeight.bold,
                                                  fontSize: 12
                                              )),
                                        ...
                                        Container(
                                          ...
                                          child: Column(
                                            ...
                                            crossAxisAlignment: CrossAxisAlignment.start,
                                            children: [
                                              Text('الاجمالى :${cubit.totalPrice.text} ',style: GoogleFonts.notoKufiArabic(
                                                  color: MyConstant().purpleColor,
                                                  fontWeight: FontWeight.bold,
                                                  fontSize: 12
                                              )),
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: Row(
                                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                              children: [
                                                Expanded(child: Container( width: MediaQuery.of(context).size.width/6,child: MyText(text: 'الاجمالي  : ${cubit.totalPriceDetails.text}'),)),
                                                Expanded(child: Container( width: MediaQuery.of(context).size.width/6, child: MyText(text: ' الخصم : ${cubit.discount.text}'),)),
                                                Expanded(child: Container( width: MediaQuery.of(context).size.width/6, child: MyText(text: ' الضريبة : ${cubit.tax.text}'),)),
                                                Expanded(child: Container( width: MediaQuery.of(context).size.width/6, child: MyText(text: ' الصافي : ${cubit.whatYouPay.text}'),)),
                                          ...
                                          Padding(
                                            ...
                                            child: Row(
                                              ...
                                              // crossAxisAlignment: CrossAxisAlignment.center,
                                              children: [
                                                Expanded(child: Container( width: MediaQuery.of(context).size.width/6, child: MyText(text: ' المدفوع النقدي : ${cubit.cash.text}'),)),
                                                Expanded(child: Container( width: MediaQuery.of(context).size.width/6, child: MyText(text: ' المدفوع الشبكي : ${cubit.onlinePayment.text}'),)),
                                                Expanded(child: Container( width: MediaQuery.of(context).size.width/6, child: MyText(text: ' نوع الشبكة : ${cubit.paymentType}'),)),
                                                Expanded(child: Container( width: MediaQuery.of(context).size.width/6, child: MyText(text: 'المبلغ المتبقي : ${cubit.delayMoney.text}'),)),
                      ...
                      Expanded(
                        ...
                        child: Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            if(cubit.pngBytes!=null)
                              Image.memory(cubit.pngBytes!),
